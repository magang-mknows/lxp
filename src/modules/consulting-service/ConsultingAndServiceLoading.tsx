...
const ConsultingAndServiceLoading: FC = (): ReactElement => {
  return (
    <section className="pt-[138px] bg-neutral-50/60  min-h-[100vh]">
      ...
      <div className="mt-2 md:mt-6 bg-neutral-200 animate-pulse lg:mt-8 relative mb-28 h-52 lg:h-64 rounded-md shadow-sm mx-8 md:mx-14 lg:mx-16 px-8 md:px-14 lg:px-16  flex flex-col justify-center items-center ">
        <div className="flex w-full justify-center mb-4">
          <div className="h-10 mb-2 bg-neutral-300 w-40 rounded-md animate-pulse"></div>
        </div>
