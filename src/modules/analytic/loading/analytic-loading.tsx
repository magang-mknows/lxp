...
import AnalyticGraphLoading from "./analytic-graph-loading";
import AnalyticIconLoading from "./analytic-icon-loading";
import AnalyticPerformanceLoading from "./analytic-performance-loading";
import AnalyticRecentPerformanceLoading from "./analytic-recent-performance-loading";
import AnalyticSidebarLoading from "./analytic-sidebar-loading";
