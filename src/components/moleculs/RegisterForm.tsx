...
const RegisterForm: FC = (): ReactElement => {
  ...
  return (
    <div>
      <Form
        onSubmit={onSubmit}
        className="flex flex-col justify-center px-8 md:px-14 lg:px-16 pt-10"
      >
        ...
        <div className="flex flex-col my-6 md:py-8">
          ...
          <div className="flex justify-center text-neutral-900 text-xs md:text-sm pt-4">
            <h1>
              Sudah punya akun ?
              <span
                className="text-version2-400 cursor-pointer hover:underline text-xs md:text-sm font-bold"
                onClick={() => {
                  setLoginPopup(true);
                }}
              >
