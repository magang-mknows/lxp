...
import RequestSimulationCardLoading from "@/modules/drill-simulation/loading/request-simulation-card-loading";
import { dummySceduleSimulation } from "@/modules/drill-simulation/store";
import dynamic from "next/dynamic";
import { FC, ReactElement, Suspense } from "react";
import { useRecoilValue } from "recoil";

const RequestSimulationCard = dynamic(() => import("../atoms/request-simulation-card"), {
  ssr: false,
