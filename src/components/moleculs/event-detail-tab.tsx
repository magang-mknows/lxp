...
import EventCard from "../atoms/event-card";
import EventContactCard from "../atoms/event-contact-card";
import EventDetaiDescription from "../atoms/event-detai-description";
import RelatedEvent from "../atoms/related-event";
