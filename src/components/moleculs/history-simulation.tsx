"use client";
import HistorySimulationCardLoading from "@/modules/drill-simulation/loading/history-simulation-card-loading";
import { dummyRegisteredSimulation } from "@/modules/drill-simulation/store";
import dynamic from "next/dynamic";
import { FC, Fragment, ReactElement } from "react";
import { useRecoilValue } from "recoil";

const HistorySimulationCard = dynamic(() => import("../atoms/history-simulation-card"), {
  ssr: false,
