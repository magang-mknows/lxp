...
import DiscussionPostOption from "../atoms/discussion-post-option";
import DiscussionSearch from "../atoms/discussion-search";
import DiscussionCard from "../atoms/disscucion-card";

const DiscussionComment = lazy(() => import("./discussion-comment"));
