...
import RelatedGlimpseKnowledgeCard from "./RelatedGlimpseKnowledgeCard";

const GlimpseKnowledgeLayoutMain: FC = (): ReactElement => {
  return (
...
export default GlimpseKnowledgeLayoutMain;
