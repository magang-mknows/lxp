...
import TrainingInformationInfo from "../atoms/TrainingInformationInfo";
...
const TrainingInformationHeader: FC = (): ReactElement => {
        ...
        <section className="flex flex-col px-10 py-6">
          ...
          <main>
            ...
            <section className="flex gap-4 flex-wrap md:flex-nowrap">
              ...
              />
              <Link passHref href={"/rencana-pelatihan/kontrak-pelatihan"} className="w-full">
                <Button
                  type="primary"
                  size="full"
                  text="Konfirmasi"
...
export default TrainingInformationHeader;
