      ...
      >
        <Menu.Items className="absolute right-0 top-2 origin-top-right   bg-white   shadow-md   rounded-md overflow-hidden">
          ...
          <div className="grid grid-cols-2 ">
            <Link href={"ruang-diskusi"} className="bg-neutral-100 hover:bg-neutral-200">
              <Menu.Item
                as="div"
                aria-label="User"
                className={
            ...
            <Link href={"/"} className="bg-neutral-100 hover:bg-neutral-200">
              <Menu.Item
                as="div"
                className={
                  "flex flex-col gap-2 items-center p-4 cursor-pointer bg-neutral-100 hover:bg-neutral-200 transition-all duration-300 ease-in-out"
            ...
            <Link href={"/analitik"} className="bg-neutral-100 hover:bg-neutral-200">
              <Menu.Item
                as="div"
                className={
                  "flex flex-col gap-2 items-center p-4 cursor-pointer bg-neutral-100 hover:bg-neutral-200 transition-all duration-300 ease-in-out"
