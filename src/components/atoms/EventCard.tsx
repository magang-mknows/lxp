...
const EventCard: FC<TEventCardProps> = ({ isOrder }): ReactElement => {
  return (
    <div className="bg-neutral-50 shadow-sm rounded-md w-full px-7 py-10 mb-6">
      <header className="flex w-full  items-center gap-3 mb-8 text-neutral-800">
        {isOrder ? (
