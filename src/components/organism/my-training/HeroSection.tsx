...
const HeroSection = (): ReactElement => {
  const hero = [
    { icon: "/assets/pelatihanku/matkul.svg", jumlah: "6", detail: "pelatihan", warna: "#E3FBDA" },
    { icon: "/assets/pelatihanku/matkul.svg", jumlah: "144", detail: "poin", warna: "#FEF6D0" },
    {
      icon: "/assets/pelatihanku/matkul.svg",
      jumlah: "3.187",
      detail: "karyawan",
      warna: "#E9F6FD",
    },
  ...
  return (
    <div className="flex lg:flex-row flex-col gap-6 ">
      <div className="lg:basis-1/4 lg:justify-start justify-center sm:hidden lg:inline-block xs:inline-block">
        <Image
          src={"/assets/pelatihanku/Dummy.svg"}
          alt={"dummy"}
      ...
      <div className="flex flex-col">
        ...
        <p className="text-[#525252] text-[14px] font-[400] py-2">
          ...
          akuntan dengan mengajar mereka tentang prinsip-prinsip akuntansi seperti audit, pelaporan,
