...
import deleteICon from "@/assets/pelatihanku/delete.svg";
import { MdDelete } from "react-icons/md";
import { RiPencilFill } from "react-icons/ri";
import more from "/public/assets/pelatihanku/more.svg";
import LikeComment from "./likeComment";
import { usePopupEditDiscussion } from "./usePopupEditDiscussion";
import { usePopupDeleteDiscussion } from "./usePopupDeleteDiscussion";
import { cardAuthor } from "./type";
import Modal from "@/components/atoms/Modal";

const CardComment: FC<cardAuthor> = ({
  title,
  avatar,
  time,
  content,
