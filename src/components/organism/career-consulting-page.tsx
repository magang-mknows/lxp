...
import CareerConsultingHeader from "../moleculs/career-consulting-header";
import ConsultingChatContainer from "../moleculs/consulting-chat-container";

const ConsultingChatList = lazy(() => import("../moleculs/consulting-chat-list"));
