...
import moduleFour from "/public/assets/leaderboard/module-four.svg";
  ...
  return (
    ...
    >
      <div className="my-auto flex justify-center md:gap-[10px] gap-[4px] items-center">
        ...
        <p className="text-[#106FA4] md:text-[14px] text-[10px] dark:text-white">Filter</p>
      </div>
      {open && (
        <div className="flex justify-end container mt-[10px] z-[9000] absolute w-[150px] ease-in-out ">
          <div className="w-[160px] h-[115px] rounded-[8px] text-center  overflow-hidden shadow-2xl ">
            ...
            >
              ...
              ></div>
              <p className="text-[#262626] md:text-[14px] text-[10px] my-auto ml-3">Pelatihan</p>
            </button>
            <button
              className="flex justify-start h-[38px] relative hover:bg-[#F5F5F5] w-full bg-[#FFF] "
            ...
            >
              ...
              ></div>
              <p className="text-[#262626] md:text-[14px] text-[10px] my-auto ml-3">Batch</p>
            </button>
          </div>
        </div>
      )}
