...
import BaseScoreTable from "../moleculs/base-score-table";
import ScoreChart from "../moleculs/score-chart";
import ScoreSummaryTable from "../moleculs/score-summary-table";
import SertificateList from "../moleculs/sertificate-list";
